...
const styles = StyleSheet.create({
  ...
  safe: { flex: 1 },
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: FEED_COLORS.border, gap: 12 },
  backButton: { padding: 8, marginLeft: -8 },
  headerSpacer: { flex: 1 },
  title: { flex: 1, fontSize: 18, fontFamily: 'DMSans-Bold', fontWeight: '700', color: FEED_COLORS.textPrimary, textAlign: 'center' },
  previewCard: { marginHorizontal: 16, marginTop: 14, padding: 14, borderRadius: 16, borderWidth: 1, borderColor: FEED_COLORS.border, backgroundColor: FEED_COLORS.surface, flexDirection: 'row', alignItems: 'center', gap: 16 },
  avatarContainer: { width: 140, height: 140, backgroundColor: FEED_COLORS.surface2, borderRadius: 12, borderWidth: 1, borderColor: FEED_COLORS.border, position: 'relative', overflow: 'hidden' },
  ...
  catBtn: { flex: 1, paddingVertical: 8, borderRadius: 8, backgroundColor: FEED_COLORS.surface2, alignItems: 'center', borderWidth: 1, borderColor: 'transparent' },
  catBtnActive: { backgroundColor: `${FEED_COLORS.favor}15`, borderColor: FEED_COLORS.favor },
  catBtnText: { fontSize: 12, color: FEED_COLORS.textSecondary, fontFamily: 'DMSans-Medium' },
  catBtnTextActive: { color: FEED_COLORS.favor, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  previewTextWrap: { justifyContent: 'flex-end' },
  previewLabel: { fontSize: 12, color: FEED_COLORS.textSecondary, fontFamily: 'DMSans-Medium' },
  previewName: { marginTop: 4, fontSize: 18, color: FEED_COLORS.textPrimary, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  tabsContainer: { marginTop: 16, borderBottomWidth: 1, borderBottomColor: FEED_COLORS.border },
  tabsContent: { paddingHorizontal: 16, gap: 8, paddingBottom: 12 },
  tab: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: FEED_COLORS.surface, borderWidth: 1, borderColor: FEED_COLORS.border },
  tabActive: { backgroundColor: FEED_COLORS.item, borderColor: FEED_COLORS.item },
  tabText: { fontSize: 14, color: FEED_COLORS.textSecondary, fontFamily: 'DMSans-Medium' },
  tabTextActive: { color: '#102010', fontFamily: 'DMSans-Bold', fontWeight: '700' },
  list: { flex: 1, marginTop: 12 },
  listContent: { paddingHorizontal: 16, paddingBottom: 24, gap: 10 },
  emptyState: { borderRadius: 14, borderWidth: 1, borderColor: FEED_COLORS.border, backgroundColor: FEED_COLORS.surface, paddingHorizontal: 14, paddingVertical: 16 },
  emptyStateText: { fontSize: 13, color: FEED_COLORS.textSecondary, fontFamily: 'DMSans-Regular' },
  itemCard: { borderRadius: 14, borderWidth: 1, borderColor: FEED_COLORS.border, backgroundColor: FEED_COLORS.surface, paddingHorizontal: 12, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  itemCardSelected: { borderColor: FEED_COLORS.favor, backgroundColor: `${FEED_COLORS.favor}15` },
  itemLeft: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  itemSpriteWrap: { width: 52, height: 52, borderRadius: 12, borderWidth: 1, borderColor: FEED_COLORS.border, backgroundColor: FEED_COLORS.surface2, alignItems: 'center', justifyContent: 'center' },
  itemName: { fontSize: 15, color: FEED_COLORS.textPrimary, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  itemMeta: { marginTop: 2, fontSize: 12, color: FEED_COLORS.textSecondary, fontFamily: 'DMSans-Regular' },
  ...
  statePillText: { fontSize: 11, color: FEED_COLORS.item, fontFamily: 'DMSans-Bold', fontWeight: '700' },
  footer: { paddingHorizontal: 16, paddingTop: 12, paddingBottom: 20, borderTopWidth: 1, borderTopColor: FEED_COLORS.border, backgroundColor: FEED_COLORS.bg },
  applyBtn: { height: 48, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: FEED_COLORS.item, borderWidth: 1, borderColor: FEED_COLORS.item },
