...
export default function AuthScreen() {
	...
	const isEduEmail = /^[^\s@]+@[^\s@]+\.edu$/i.test(trimmedEmail);
	const showEduError = trimmedEmail.length > 0 && !isEduEmail;
						...
						<View style={styles.formBlock}>
							<View style={styles.fieldBlock}>
								<View
									style={[
										styles.inputShell,
										showEduError && styles.inputShellError,
									]}
								>
									<Ionicons
										name="mail"
										size={17}
										color={showEduError ? COLORS.error : COLORS.textSecondary}
